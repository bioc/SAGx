...
\details{It is assumed that missing gene symbol is coded as "". Note also that other measurements than present rate may be useful as selection criterion, such 
some variation measure. The function only assumes that high values are desirable.}
